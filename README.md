...
For example, if you want to emulate a DV with poison reverse on a 6 nodes random network and save the results in the exercise.pdf file you should run

```
python3 create-problem.py -r DVPR -n 6 -g random -f ./exercise.pdf -s 3
```
